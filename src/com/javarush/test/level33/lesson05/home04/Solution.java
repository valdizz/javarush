...
public class Solution {
    ...
    public static Object convertOneToAnother(Object one, Class resultClassObject) throws IOException {
        ...
        st.replaceFirst(one.getClass().getSimpleName().toLowerCase().toString(), resultClassObject.getClass().getSimpleName().toLowerCase().toString());
        StringReader stringReader = new StringReader(st);
        Object o = mapper.readValue(stringReader, resultClassObject);
        return o;
    }
