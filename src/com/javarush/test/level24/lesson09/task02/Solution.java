    ...
    public static void sort(List<Stock> list) {
        Collections.sort(list, new Comparator<Stock>()
        {
            public int compare(Stock stock1, Stock stock2)
            {
                ...
                flag = Integer.compare(date2.getYear(), date1.getYear());
                if (flag != 0) return flag;
                flag = Integer.compare(date2.getMonth(), date1.getMonth());
                if (flag != 0) return flag;
                flag = Integer.compare(date2.getDay(), date1.getDay());
                if (flag != 0) return flag;
                double saldo1 = (double)stock1.get("last")-(double)stock1.get("open");
                double saldo2 = (double)stock2.get("last")-(double)stock2.get("open");
                flag = Double.compare(saldo2, saldo1);
                return flag;
            }
        });
    }
