...
public class Solution {
    public static AtomicInteger countThreadFactoriess = new AtomicInteger(0);
    ...
    public static class AmigoThreadFactory implements ThreadFactory{
        ...
        public AtomicInteger countThreadFactories = new AtomicInteger(0);

        public AmigoThreadFactory()
        {
            countThreadFactories.set(countThreadFactoriess.incrementAndGet());
        }
        ...
        public Thread newThread(Runnable r)
        {
            ...
            thread.setName(thread.getThreadGroup().getName()+"-pool-"+countThreadFactories.toString()+"-thread-"+countThreads.toString());
            return thread;
        }
    }
}
